...
class Briefnote_Audit_Log {
    ...
    public static function get_action_types() {
        return array(
            // Credential actions
            self::ACTION_VIEWED   => __( 'Credential Viewed', 'briefnote' ),
            self::ACTION_COPIED   => __( 'Credential Copied', 'briefnote' ),
            self::ACTION_CREATED  => __( 'Credential Created', 'briefnote' ),
            self::ACTION_MODIFIED => __( 'Credential Modified', 'briefnote' ),
            self::ACTION_DELETED  => __( 'Credential Deleted', 'briefnote' ),
            // Notes actions
            self::ACTION_NOTES_ACCESSED => __( 'Notes Accessed', 'briefnote' ),
            self::ACTION_NOTES_SAVED    => __( 'Notes Saved', 'briefnote' ),
            self::ACTION_NOTES_COPIED   => __( 'Notes Copied', 'briefnote' ),
            self::ACTION_NOTES_PASTED   => __( 'Notes Pasted', 'briefnote' ),
            self::ACTION_NOTES_EXPORTED => __( 'Notes Exported', 'briefnote' ),
        );
    }
    ...
    public static function get_credential_action_types() {
        return array(
            self::ACTION_VIEWED   => __( 'Viewed', 'briefnote' ),
            self::ACTION_COPIED   => __( 'Copied', 'briefnote' ),
            self::ACTION_CREATED  => __( 'Created', 'briefnote' ),
            self::ACTION_MODIFIED => __( 'Modified', 'briefnote' ),
            self::ACTION_DELETED  => __( 'Deleted', 'briefnote' ),
        );
    }
    ...
    public static function get_notes_action_types() {
        return array(
            self::ACTION_NOTES_ACCESSED => __( 'Accessed', 'briefnote' ),
            self::ACTION_NOTES_SAVED    => __( 'Saved', 'briefnote' ),
            self::ACTION_NOTES_COPIED   => __( 'Content Copied', 'briefnote' ),
            self::ACTION_NOTES_PASTED   => __( 'Content Pasted', 'briefnote' ),
            self::ACTION_NOTES_EXPORTED => __( 'Exported', 'briefnote' ),
        );
    }
    ...
    public static function log( $action_type, $credential_label, $credential_id = null, $details = null ) {
        ...
        $table = Briefnote_Database::get_audit_log_table();
    ...
    public static function get_logs( $args = array() ) {
        ...
        if ( $results ) {
            foreach ( $results as &$row ) {
                ...
                $row['user_display_name'] = $user ? $user->display_name : __( 'Unknown User', 'briefnote' );
